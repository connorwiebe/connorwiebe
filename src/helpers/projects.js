module.exports = [
  {
    ...
    title: 'dreambounty',
    date: 'Feb 20, 2018',
    image: 'https://i.imgur.com/0CnqIjI.png',
  ...
  },
  {
    ...
    title: 'status',
    date: 'Jan 20, 2018',
    image: 'https://i.imgur.com/Qaz8UF2.png',
    ...
    url: 'https://podjunky.herokuapp.com/',
    title: 'podjunky',
    date: 'Nov 18, 2017',
    image: 'https://i.imgur.com/YqWXX2N.png',
    description: `Streamlined listening for podcast junkies. Firebase, Node.js, Express, jQuery, Pug. It pulls podcast data from the iTunes RSS feed and saves
    subscriptions in Google's Firebase data store.`,
  }, {
    url: 'https://phloot.herokuapp.com/',
    title: 'phloot',
    date: 'Oct 2, 2017',
    image: 'https://i.imgur.com/QN3TYIC.png',
    description: `Recommends songs for you based on artists you like. One of the first projects I created at the start of my education using Node.js, Express, Pug.
    It works by plugging into the Last.fm API and randomly selecting similar artists' songs.`,
  }, {
    url: 'https://www.npmjs.com/package/crypto-alphanumeric-id',
    title: 'crypto-alphanumeric-id',
    date: 'Dec 11, 2016',
    image: 'https://i.imgur.com/2oVCO96.png',
